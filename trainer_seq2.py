                    ...
                    for batch in self.train_loader:
                        ...
                        for r in range(self.config.sample.n_samples):
                            with torch.no_grad():
                                ...
                                pred_all = self.model.decode(z, batch)
                                ...
                                for i in range(batch_size):
                                    ...
                                    with open("g"+str(epoch)+"_sample2.pkl","wb") as fout:
                                        seq_lst.append([epoch, aa,pred_all.cpu(), pred_aa.cpu(), pos_batch.cpu(), mask_batch.cpu()])
